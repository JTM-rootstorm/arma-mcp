...
export const DIRECT_BRIDGE_ACTIONS = [
  ...
  ["eden.create_group", "write", "arma.eden.create_group", true, "none", "eden-write", "create_group"],
  ["eden.create_unit", "write", "arma.eden.create_unit", true, "none", "eden-write", "create_unit"],
  ["eden.list_group_units", "read", "arma.eden.list_group_units", false, "none", "eden-read"],
  ["eden.assign_unit_to_group", "write", "arma.eden.assign_unit_to_group", true, "none", "eden-write", "assign_unit_to_group"],
  ["eden.create_waypoint", "write", "arma.eden.create_waypoint", true, "none", "eden-write", "create_waypoint"],
  ["eden.set_group_attributes", "write", "arma.eden.set_group_attributes", true, "none", "eden-write"],
  ["eden.set_waypoint_attributes", "write", "arma.eden.set_waypoint_attributes", true, "risky-write", "eden-write", "set_waypoint_attributes"],
  ["eden.reorder_waypoints", "write", "arma.eden.reorder_waypoints", true, "none", "eden-write", "reorder_waypoints"],
  ["eden.attach_waypoint_to_group", "write", "arma.eden.attach_waypoint_to_group", true, "none", "eden-write"],
  ["eden.delete_waypoint", "destructive", "arma.eden.delete_waypoint", true, "required", "eden-write", "delete_waypoint"],
  ["eden.get_group_links", "read", "arma.eden.get_group_links", false, "none", "eden-read"],
  ["eden.get_waypoint_links", "read", "arma.eden.get_waypoint_links", false, "none", "eden-read"],
